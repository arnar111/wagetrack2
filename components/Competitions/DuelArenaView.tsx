                ...
                <div className="p-6 pb-2 text-center">
                    ...
                    <div className="flex justify-between items-center px-4">
                        ...
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-2xl font-black text-white mt-2">15.500</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-1">
                            ...
                            <div className="text-[10px] font-bold text-slate-500 flex items-center gap-1"><Clock size={10} /> 14:22 eftir</div>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-2">
                            <div className="h-16 w-16 rounded-2xl bg-slate-700 flex items-center justify-center text-slate-400 border-2 border-slate-600 relative">
                                <Ghost size={32} />
                                <div className="absolute -bottom-3 bg-slate-800 px-2 py-0.5 rounded-lg text-[10px] font-black border border-slate-600">Ghost</div>
                            </div>
                            <p className="text-2xl font-black text-slate-400 mt-2">12.000</p>
                        </div>
                    </div>

                    {/* Progress Bars */}
                    <div className="mt-8 flex gap-1 h-3 rounded-full overflow-hidden bg-white/5 relative">
                        <div className="bg-indigo-500 h-full transition-all duration-1000" style={{ width: '55%' }} />
                        <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-white/10 -translate-x-1/2" />
                        <div className="bg-rose-500 h-full absolute right-0 transition-all duration-1000" style={{ width: '40%' }} />
                    </div>
                    <p className="text-[10px] text-slate-500 uppercase tracking-widest mt-3">Markmið: Fyrstur í 20.000 kr</p>
                </div>
            </div>
